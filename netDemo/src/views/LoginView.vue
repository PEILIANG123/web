        ...
        <el-col :span="6" :offset="3" class="form">
            ...
            <el-form ref="form" size="large" autocomplete="off" v-if="isRegister" :model="registerData" :rules="rules">
                ...
                <el-form-item class="flex">
                    <el-link type="info" :underline="false" @click="isRegister = false;clearRefisterData()">
                        ← 返回
                    </el-link>
                </el-form-item>
            </el-form>
            ...
            <el-form ref="form" size="large" autocomplete="off" v-else :model="registerData" :rules="rules">
                ...
                <el-form-item prop="password">
                    <el-input show-password name="password" :prefix-icon="Lock" type="password" placeholder="请输入密码" v-model="registerData.password"></el-input>
                </el-form-item>
                <el-form-item class="flex">
                    <div class="flex">
                ...
                <el-form-item class="flex">
                    <el-link type="info" :underline="false" @click="isRegister = true;clearRefisterData()">
                        注册 →
                    </el-link>
                </el-form-item>
            </el-form>
